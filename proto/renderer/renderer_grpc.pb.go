...
const (
	RendererService_RenderPoster_FullMethodName = "/renderer.RendererService/RenderPoster"
)
...
type RendererServiceClient interface {
	RenderPoster(ctx context.Context, in *RenderRequest, opts ...grpc.CallOption) (*RenderResponse, error)
}
...
func (c *rendererServiceClient) RenderPoster(ctx context.Context, in *RenderRequest, opts ...grpc.CallOption) (*RenderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RenderResponse)
	err := c.cc.Invoke(ctx, RendererService_RenderPoster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RendererServiceServer interface {
	RenderPoster(context.Context, *RenderRequest) (*RenderResponse, error)
...
func (UnimplementedRendererServiceServer) RenderPoster(context.Context, *RenderRequest) (*RenderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RenderPoster not implemented")
}
...
func _RendererService_RenderPoster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RendererServiceServer).RenderPoster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RendererService_RenderPoster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RendererServiceServer).RenderPoster(ctx, req.(*RenderRequest))
	}
...
var RendererService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RenderPoster",
			Handler:    _RendererService_RenderPoster_Handler,
		},
	},
